...
@section('content')
    ...
    <form role="form" action="{{url('/kt_admin/event')}}" method="post" enctype="multipart/form-data" >
        {{csrf_field()}}
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="head_ar" id="exampleInputPassword1"  placeholder="Title ">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control"   name="s_des_ar" id="exampleInputPassword1" placeholder="Description"></textarea>
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control"  id="editor2"  rows="50" name="des_ar" id="exampleInputPassword1" placeholder="Description"></textarea>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="start" id="exampleInputPassword1"  placeholder="Title ">
                @if ($errors->has('start'))
                    <span class="help-block">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" name="end" id="exampleInputPassword1"  placeholder="Title ">
                @if ($errors->has('end'))
                    <span class="help-block">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control"   name="where" id="exampleInputPassword1" placeholder="Description"></textarea>
                @if ($errors->has('where'))
                    <span class="help-block">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control"   name="where_ar" id="exampleInputPassword1" placeholder="Description"></textarea>
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control"   name="when" id="exampleInputPassword1" placeholder="Description"></textarea>
                @if ($errors->has('when'))
                    <span class="help-block">
            ...
            <div class="form-group">
                ...
                <textarea type="text" class="form-control"   name="when_ar" id="exampleInputPassword1" placeholder="Description"></textarea>
